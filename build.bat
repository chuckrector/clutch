...
REM 4200 nonstandard extension used: nameless struct/union
...
REM
set CompilerFlags=/Gm- /GR- /GS- /Gs999999 /nologo /WX /W4 /wd4065 /wd4100 /wd4101 /wd4189 /wd4200 /wd4201 /wd4505 /wd4576 /wd4702 /wd4706 /wd4996 /FC /Od /Z7
...
start /b cl %CompilerFlags% ..\%CurrentFolderName%.c /link %LinkerFlags% advapi32.lib
start /b cl %CompilerFlags% ..\tests.c /link %LinkerFlags%
